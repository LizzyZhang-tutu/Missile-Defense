...
using UnityEngine;
using System.IO; //IO related API.
...
public class ShopManager : MonoBehaviour {
    ...
    private string content = "<SaveData><GoldCount>0</GoldCount><BestScore>0</BestScore><ID0>1</ID0><ID1>0</ID1><ID2>0</ID2><ID3>0</ID3></SaveData>";
